...
public class PopPicturesAdapter extends BaseAdapter {

    private String TAG = PopPicturesAdapter.class.getSimpleName();
    private Activity activity;
	private List<String> hlistviewUrls;
    private int size;

    public PopPicturesAdapter(Activity activity, List<String> hlistviewUrls) {
