...
public class CarUpkeepAdapter extends BaseAdapter {

    private String TAG = CarUpkeepAdapter.class.getSimpleName();
    private Activity activity;
	private List<Map<String, Object>> datas;
    private int size;
	private int width ,height;

    public CarUpkeepAdapter(Activity activity, List<Map<String, Object>> datas) {
