...
import com.huanyun.autocar.adapter.CarUpkeepAdapter;
 ...
 * 保养
 */
public class CarUpkeepActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener,
		RefreshLayout.OnLoadListener{

	public static final String TAG = CarUpkeepActivity.class
			.getSimpleName();
	public static CarUpkeepActivity whoseCarActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		latitude = CommonSettingProvider.getLatitude(CarUpkeepActivity.this);
		longitude = CommonSettingProvider.getLongitude(CarUpkeepActivity.this);
		setContentView(R.layout.activity_car_upkeep);
		initView();
		initData();
		setListener();
	}
...
//		commonTitleBar.setRightImg(R.mipmap.ic_launcher);
	...
	private void initData(){
		...
		if(carWashAdapter==null){
			carWashAdapter = new CarWashAdapter(CarUpkeepActivity.this,workData,3);
		}
	...
	private void getProductList(int pageNo, String longitude,String latitude,int type){
		Api api = new Api(CarUpkeepActivity.this, new RequestCallBack<Object>() {
			@Override
			public void onStart() {
				super.onStart();
			}
			...
			public void onSuccess(ResponseInfo<Object> arg0) {
				...
				if (error == null || error.equals("")) {
					...
					Toast.makeText(CarUpkeepActivity.this, error, Toast.LENGTH_SHORT).show();
				}
			}
	...
	public void onLoad() {
		...
		refreshLayout.postDelayed(new Runnable() {
			...
			public void run() {
				...
				if(!noMore){
					page++;
					getProductList(page, longitude,latitude,3);
				}else{
					refreshLayout.setLoading(false);
				}
			}
