 ...
 * 洗车
 */
public class CarWashActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener,
		RefreshLayout.OnLoadListener{

	public static final String TAG = CarWashActivity.class
			.getSimpleName();
	public static CarWashActivity whoseCarActivity;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		latitude = CommonSettingProvider.getLatitude(CarWashActivity.this);
		longitude = CommonSettingProvider.getLongitude(CarWashActivity.this);
...
//		commonTitleBar.setRightImg(R.mipmap.ic_launcher);
	...
	private void initData(){
		...
		if(carWashAdapter==null){
			carWashAdapter = new CarWashAdapter(CarWashActivity.this,workData,1);
		}
	...
	private void getProductList(int pageNo, String longitude,String latitude,int type){
		Api api = new Api(CarWashActivity.this, new RequestCallBack<Object>() {
			@Override
			public void onStart() {
				super.onStart();
			}
			...
			public void onSuccess(ResponseInfo<Object> arg0) {
				...
				if (error == null || error.equals("")) {
					...
					Toast.makeText(CarWashActivity.this,error,Toast.LENGTH_SHORT).show();
				}
			}
	...
	public void onLoad() {
		...
		refreshLayout.postDelayed(new Runnable() {
			...
			public void run() {
				...
				if(!noMore){
					page++;
					getProductList(page, longitude,latitude,1);
				}else{
					refreshLayout.setLoading(false);
				}
			}
